...
//
//                        Training sd=new Training(entry.getTitle(),entry.getTitleUrl(),entry.getIconUrl(),entry.getType(),ts);
//                        feedList.add(sd);
...
//
//                        TrainingListPresenter feedListPresenter= new TrainingListPresenter(feedList);
//                        TrainingRecyclerAdapter mAdapter = new TrainingRecyclerAdapter(feedListPresenter,new RecyclerViewClickListener(){
//                            @Override
